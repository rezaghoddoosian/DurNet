...
def action_accuracy2(p_actions,g_actions): #The reference is the predicted labels. What percentage of the predicted labels are present in the video ?
    ...
    def sub_action_accuracy(p_actions,g_action):   #for 1 video, for each video evaluates the percentage of correctly detected action labels disregarding time_stamps
